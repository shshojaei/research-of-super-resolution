...
def dssim_contrast(img1, img2, max_val=255):
    ...
    covar1 = tf.reduce_mean((img1 - mu1), axis=[1, 2, 3], keepdims=True)
    covar2 = tf.reduce_mean((img2 - mu2), axis=[1, 2, 3], keepdims=True)
    ...
    # Calculate SSIM
    numerator = (2 * covar1 * covar2 + c2)
    denominator = (var1 + var2 + c2)
