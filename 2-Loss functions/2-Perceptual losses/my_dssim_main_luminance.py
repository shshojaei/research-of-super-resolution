...
def my_dssim_main_luminance(y_true, y_pred):
  ...
  #y_true = tfa.image.gaussian_filter2d(y_true, filter_shape=(3,3), sigma=sigma_value) #input and output is a Tensor
  #y_pred = tfa.image.gaussian_filter2d(y_pred, filter_shape=(3,3), sigma=sigma_value)
